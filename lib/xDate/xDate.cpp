...
//        m_iMonth = timeInfo.tm_mon;
//        m_iDay = timeInfo.tm_mday;
//    }
...
//===========================================================================//
LONG
xDate::CalcDateDiff(WORD iEndYear, WORD iEndMonth, WORD iEndDay, WORD iStartYear, WORD iStartMonth, WORD iStartDay) {
...
//===========================================================================//
void xDate::GetDate(WORD &iYear, WORD &iMonth, WORD &iDay) const {
    iYear = m_iYear;
    iMonth = m_iMonth;
    iDay = m_iDay;
}
...
String xDate::mapSolarTerm(u8_t number) {
    String solarTerms[] = {"", "小寒", "大寒", "立春", "雨水",
                           "惊蛰","春分", "清明", "谷雨",
                           "立夏", "小满","芒种", "夏至",
                           "小暑", "大暑","立秋", "处暑",
                           "白露", "秋分", "寒露","霜降",
...
//===========================================================================//
// UTF-8编码 占用3个字节
String xDate::FormatLunarYear(WORD iYear) {
    String szT1[] = {"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"};
    String szT2[] = {"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"};
    String szT3[] = {"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"};

    return szT1[((iYear - 4) % 10)] + szT2[((iYear - 4) % 12)] + "[" + szT3[((iYear - 4) % 12)] + "年" + "]";
}

//===========================================================================//
String xDate::FormatLunarMonth(WORD iMonth) {
    String szText[] = {"正", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
    if (iMonth <= 10) {
...
//===========================================================================//
String xDate::FormatLunarDay(WORD iDay) {
    String szText1[] = {"初", "十", "廿", "三"};
    String szText2[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
    if (iDay != 20 && iDay != 30) {
        return szText1[((iDay - 1) / 10)] + szText2[((iDay - 1) % 10)];
    } else if (iDay == 20) {
        return "二十";
    } else if (iDay == 30) {
        return "三十";
